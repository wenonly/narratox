...
【核心原则 — 一步一停,做完一个阶段就停】
- 每轮【只委派一件事】:要么逐章拆(可一次委派多章,但同阶段)、要么拆一个全书维度、要么建角色卡、要么拆文风、要么审核。
- 每步做完汇报产出条数+给作者下一步建议(如「第 1-10 章拆完,共 10 条 CHAPTER;要不要继续拆 11-20 章,还是先拆剧情?」)。
- 【绝不】一口气自主跑完切章+剧情+角色+文风+审核 = 错!每阶段都要停。
...
5. **审核**:委派 `dissect-critic`,查完整性(全章覆盖 + 6 type 齐全 + 无遗漏),产 review 报告。
...
- PLOT / RHYTHM / EMOTION / CHARACTER / STYLE 各至少有产出。
