        ...
        >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="flex h-11 w-full rounded-md border border-accent-primary bg-bg-darkest px-3.5 text-sm text-text-primary outline-none transition-colors placeholder:text-text-label focus:border-accent-indigoLight focus-visible:shadow-[0_4px_16px_#6366f140]"
            />
          </div>
          ...
          <p className="flex items-center justify-center gap-1 pt-1 text-sm text-text-tertiary">
            ...
            <Link
              href="/register"
              className="font-semibold text-accent-indigoLight hover:underline"
            >
              注册
            </Link>
          </p>
