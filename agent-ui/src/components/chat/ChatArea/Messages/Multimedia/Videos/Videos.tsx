    ...
    <div>
      <div className="group relative w-full max-w-xl">
        ...
        <button
          ...
          className="absolute right-2 top-2 flex items-center justify-center rounded-sm bg-overlay-10 p-1.5 opacity-0 transition-opacity duration-200 hover:bg-bg-cardElevated group-hover:opacity-100"
